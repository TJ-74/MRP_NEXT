(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_a84ef0bd._.js", {
...
function Chat() {
    ...
    const [sessionId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "Chat.useState": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uuid$2f$dist$2f$esm$2d$browser$2f$v4$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__["v4"])()
    }["Chat.useState"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Chat.useEffect": ()=>{
            const loadMessages = {
                "Chat.useEffect.loadMessages": async ()=>{
                    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('messages').select('*').eq('session_id', sessionId).order('created_at', {
                        ascending: true
                    });
                    if (error) {
                    ...
                    if (data && data.length > 0) {
                        const formattedMessages = data.map({
                            "Chat.useEffect.loadMessages.formattedMessages": (msg)=>({
                                    id: msg.id,
                                    text: msg.content,
                                    sender: msg.role === 'assistant' ? 'ai' : msg.role
                                })
                        }["Chat.useEffect.loadMessages.formattedMessages"]);
                        setMessages({
                            "Chat.useEffect.loadMessages": (prev)=>[
                                    ...prev,
                                    ...formattedMessages
                                ]
                        }["Chat.useEffect.loadMessages"]);
                    }
                }
            }["Chat.useEffect.loadMessages"];
            loadMessages();
    ...
    const handleSubmit = async (e)=>{
        ...
        await saveMessage(newUserMessage, 'user');
        try {
            ...
            await saveMessage(errorMessage, 'system');
        } finally{
            setIsLoading(false);
        }
    };
...
_s(Chat, "LjBVL/koiD1dcernTWvZCwpH7T4=");
_c = Chat;
var _c;
...
//# sourceMappingURL=src_a84ef0bd._.js.map